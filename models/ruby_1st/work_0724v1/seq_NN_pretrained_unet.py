...
def _create_timm_model_with_retries(timm, model_name, *, pretrained, num_classes):
    ...
    if local_checkpoint:
        ...
        backbone = timm.create_model(local_model_name, pretrained=False, num_classes=num_classes)
